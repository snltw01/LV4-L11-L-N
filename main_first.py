...
meteorite_IMG=pygame.transform.rotate(meteorite_IMG,45)
...
while running:
    ...
    if level ==3:
        if random.random()<0.009:
            meteorite_NPC=meteorite(random.randint(100,700),0)
    ...
    shield_text=font.render("Shield is: "+str(is_on),True,black)
